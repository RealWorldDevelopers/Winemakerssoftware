...
namespace WMS.Communications
{
    ...
    public class SugarUOMAgent : ISugarUOMAgent
    {
        private readonly HttpClient _httpClient;

        public SugarUOMAgent(HttpClient httpClient)
        {
        ...
        public async Task<IEnumerable<IUnitOfMeasure>> GetUOMs()
        {
            try
            {
                ...
                var responseMessage = await _httpClient.GetAsync("api/uom/sugar").ConfigureAwait(false);
