...
{
    public class VolumeUOMAgent : IVolumeUOMAgent
    {
        private readonly HttpClient _httpClient;

        public VolumeUOMAgent(HttpClient httpClient)
        {
        ...
        public async Task<IEnumerable<IUnitOfMeasure>> GetUOMs()
        {
            try
            {
                ...
                var responseMessage = await _httpClient.GetAsync("api/uom/vol").ConfigureAwait(false);
