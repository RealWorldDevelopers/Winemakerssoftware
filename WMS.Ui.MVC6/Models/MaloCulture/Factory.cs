...
namespace WMS.Ui.Mvc6.Models.MaloCulture
{
    ...
    {
        public MaloCulturesViewModel CreateMaloCultureModel(List<ICode> dtoCategoryList, List<ICode> dtoVarietyList, List<Domain.MaloCulture> MaloCultures)
        {
        ...
        public MaloCultureListItemViewModel CreateMaloCultureListItemViewModel(Domain.MaloCulture dto)
        {
            if (dto == null)
